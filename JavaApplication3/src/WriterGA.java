...
class WriterGA {
	...
	/*
	 * Accepts a chromosome and converts the content solution into strings then adds
	...
	/*
	 * Replaces the position of the queens with Q in the string board and a dot for
	 * indexes with no queens.
	 *
	 * @param: a 2D string board
	 * 
	 * @param: length of n
