...
class GeneticAlgorithm {
	...
	private int MAX_SELECT; // Maximum parents allowed for selection. Range: MIN_SELECT < MAX_SELECT <
							// START_SIZE
	private int OFFSPRING_PER_GENERATION; // New offspring created per generation. Range: 0 < OFFSPRING_PER_GENERATION <
											// MAX_SELECT.
	...
	public void rouletteSelection() {
		...
		for (int i = 0; i < populationSize; i++) {
			thisChromo = population.get(i);
			thisChromo.setSelectionProbability(thisChromo.getFitness() / genTotal); // set selection probability. the
																					// more fit the better selection
																					// probability
		}
	...
	/*
	 * Changes the position of the queens in a chromosome randomly according to the
	 * number of exchanges
	 *
