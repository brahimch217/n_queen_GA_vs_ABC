...
public class TesterGA {
	 ...
	 */
	public TesterGA() {
		logWriter = new WriterGA();
		MAX_RUN = 50;
		runtimes = new long[MAX_RUN];
	}

	/*
	 * Test method accepts the N/max length, and parameters mutation rate and max
	 * epoch to set for the GA accordingly.
	 *
	 * @param: max length/n
	 * 
	...
	/*
	 * Converts the parameters of GA to string and adds it to the string list in the
	 * writer class
	 *
	 */
